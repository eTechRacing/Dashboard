...
#define GLCD_CS1_PORT	GPIOB
#define GLCD_CS1 		GPIO_PIN_7														// CHANGE !!!!
* The reset pin (this is required and should not be tied high)
#define GLCD_RESET_PORT	GPIOB
#define GLCD_RESET 		GPIO_PIN_6														// CHANGE !!!!
* The A0 pin, which selects command or data mode
#define GLCD_A0_PORT 	GPIOB
#define GLCD_A0 		GPIO_PIN_8															// CHANGE !!!!
* The clock pin
#define GLCD_SCL_PORT	GPIOB
#define GLCD_SCL		GPIO_PIN_3														// CHANGE !!!!
* The data pin (SI)
#define GLCD_SDA_PORT	GPIOB
#define GLCD_SDA 		GPIO_PIN_5															// CHANGE !!!!
