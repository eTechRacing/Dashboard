...
#define Id_ETAS_Interal_Values 0xD0
#define Id_LV_Current		0x3C0
...
/**
  ...
  * @param  hcan FDCAN_HandleTypeDef structure that contains
...
void rx_sorter(FDCAN_HandleTypeDef hcan1, uint32_t TxMailbox, FDCAN_RxHeaderTypeDef RxHeader, uint8_t RxData, uint8_t *Disconnection_SteeringSensor,
