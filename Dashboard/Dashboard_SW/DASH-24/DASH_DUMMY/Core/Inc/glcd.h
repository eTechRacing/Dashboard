 ...
 * @edited by Carmen Unió Cruz <carmen.unio@estudiantat.upc.edu>
...
/**
 *
 * Display Configurations. They were in a separate .h but to simplify the code
 * where written in the same document
 *
 */

// Setup for ST7565R in SPI mode
/** The chip select pin and port*/
#define GLCD_CS1_PORT	GPIOA
#define GLCD_CS1 		GPIO_PIN_4														// CHANGE !!!!
/** The reset pin (this is required and should not be tied high) */
#define GLCD_RESET_PORT	GPIOA
#define GLCD_RESET 		GPIO_PIN_2														// CHANGE !!!!
/** The A0 pin, which selects command or data mode */
#define GLCD_A0_PORT 	GPIOA
#define GLCD_A0 		GPIO_PIN_5															// CHANGE !!!!
/** The clock pin */
#define GLCD_SCL_PORT	GPIOA
#define GLCD_SCL		GPIO_PIN_1														// CHANGE !!!!
/** The data pin (SI)*/
#define GLCD_SDA_PORT	GPIOA
#define GLCD_SDA 		GPIO_PIN_7															// CHANGE !!!!
