...
#define GLCD_CS1_PORT PIN_E2
#define GLCD_CS1 PIN_E2															// CHANGE !!!!
/** The reset pin (this is required and should not be tied high) */
#define GLCD_RESET_PORT
#define GLCD_RESET PIN_D4															// CHANGE !!!!
/** The A0 pin, which selects command or data mode */
#define GLCD_A0_PORT
#define GLCD_A0 PIN_D5															// CHANGE !!!!
/** The clock pin */
#define GLCD_SCL_PORT
#define GLCD_SCL PIN_D6															// CHANGE !!!!
/** The data pin (SI)*/
#define GLCD_SDA_PORT
#define GLCD_SDA PIN_D7															// CHANGE !!!!
